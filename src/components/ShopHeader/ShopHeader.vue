<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="toggleShopInfoShow">
    ...
    <div class="shop-header-discounts" @click="toggleSupportsShow" v-if="shopInfo.supports">
      <div class="discounts-left">
        <div class="activity" :class="supportsClass[shopInfo.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="shopInfoShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="toggleShopInfoShow"></span>
          </div>
        </div>
